...
void runSegmentation(vart::Runner* runner, bool& is_running) {
  ...
  while (is_running) {
    ...
    for (unsigned int k = 0; k < limit; k++) {
      ...
      offset= min_offset;
      axi_vptr[0]= 62500 + 25;
      axi_vptr[1]= 62500+ 25 + width;  
      axi_vptr[2]= 62500 + 50;
      axi_vptr[3]= 62500+ 50 + width;
   
     
     
      axi_vptr[4]= 126000 + 25;
      axi_vptr[5]= 126000 + 25+width;
      axi_vptr[6]= 126000  + 50;
      axi_vptr[7]= 126000  + 50+width;
      
      axi_vptr[8]= 323000 + 25;
      axi_vptr[9]= 323000  + 25 + width;
      axi_vptr[10]= 323000  + 50;
      axi_vptr[11]= 323000  + 50 + width;
 
      axi_vptr[12]= 542000 + 25;
      axi_vptr[13]= 542000 + 25+width;
      axi_vptr[14]= 542000 + 50;
      axi_vptr[15]= 542000 + 50+width;

      axi_vptr[16]= 830000 + 25;
      axi_vptr[17]= 830000 + 25+ width;
      axi_vptr[18]= 830000 + 50;
      axi_vptr[19]= 830000+ 50 + width;
    
      axi_vptr[20]=1221500 + 25;
      axi_vptr[21]=1221500  + 25+width;
      axi_vptr[22]=1221500  + 50;
      axi_vptr[23]=1221500  + 50+width;
       
      axi_vptr[24]= 2960500+ 25;
      axi_vptr[25]=2960500 + 25+width;
      axi_vptr[26]=2960500 + 50;
      axi_vptr[27]=2960500 + 50+width;


      
 
      
      axi_vptr[28]=offset + 25;
      axi_vptr[29]=offset + 25 + width;
      axi_vptr[30]=offset + 50;
      axi_vptr[31]=offset + 50 + width;
/* 
      axi_vptr[32]= 7072500 + 25;
      axi_vptr[33]= 7072500  + 25+width;
      axi_vptr[34]= 7072500  + 50;
      axi_vptr[35]= 7072500  + 50+width;
      ...
      */
      ...
      if(j % 2 == 1) {
        ...
        //std::string filename = std::string("test-faulty-mob-4") + "-" +std::string("62500") + "-"+std::string("126000") + "-" +std::string("323000")+"-" +std::string("542000")+ "-"+std::string("830000")+"-"+std::string("1221500")+"-"+std::string("2960500")+ "-" +std::to_string(offset) + ".png";
        //std::string filename = std::string("test-faulty-mob-3") + "-" +std::string("13000") +  "-" +std::string("271500") +"-" +std::string("342500") +"-" +std::string("588500") +"-" +std::string("772500")+"-" +std::string("1412500") +"-" +std::string("2909500") + "-" +std::to_string(offset) + ".png";
        ...
        std::string filename = std::string("test-faulty-mob")  +  "-"+ std::to_string(axi_vptr[199] - min_offset)  +"-" + std::to_string(min_offset) + "-" + std::to_string(axi_vptr[199]) +  "-" +std::to_string(diff_pixel) + ".png";
