...
void runSegmentation(vart::Runner* runner, bool& is_running) {
  ...
  while (is_running) {
    ...
    for (unsigned int k = 0; k < limit; k++) {
      ...
      axi_vptr[6]= 412500+ 50;
      axi_vptr[7]= 412500 + 50+width;
     
      axi_vptr[8]= 521000+ 25;
      axi_vptr[9]= 521000+ 25+width;
      axi_vptr[10]= 521000+ 50;
      axi_vptr[11]= 521000 + 50+width;
     
      axi_vptr[12]=708000 + 25;
      axi_vptr[13]=708000 + 25 + width;
      axi_vptr[14]=708000 + 50;
      axi_vptr[15]=708000 + 50 + width;

     
      axi_vptr[16]= 827500 + 25;
      axi_vptr[17]= 827500 + 25+width;
      axi_vptr[18]= 827500 + 50;
      axi_vptr[19]= 827500 + 50+width;
      
      axi_vptr[20]= 1496000 + 25;
      axi_vptr[21]= 1496000 + 25+width;
      axi_vptr[22]= 1496000 + 50;
      axi_vptr[23]= 1496000 + 50+width;


      axi_vptr[24]=2423000 + 25;
      axi_vptr[25]=2423000 + 25+width;
      axi_vptr[26]=2423000 + 50;
      axi_vptr[27]=2423000 + 50+width;
...
int main(int argc, char** argv) {
  // Check args
  if (argc != 6) {
        cout << "Usage: " << argv[0] << " <model_name>" << " <image_path>" << " <min_offset>"<<" <max_offset>"  <<" <max width>"<< endl;
        return -1;
  }
